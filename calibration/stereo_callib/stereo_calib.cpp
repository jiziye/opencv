...
StereoCalib(const vector<string> &imagelist, Size boardSize, float squareSize, bool displayCorners = false, bool useCalibrated = true, bool showRectified = true)
{
    ...
    cameraMatrix[0] = initCameraMatrix2D(objectPoints, imagePoints[0], imageSize, 0);//得到左目内参矩阵K
    cameraMatrix[1] = initCameraMatrix2D(objectPoints, imagePoints[1], imageSize, 0);//得到右目内参矩阵K
    Mat R, T, E, F;
...
=======
     ...
     //InputArrayOfArrays objectPoints,imagePoints1, imagePoints2,
     //InputOutputArray cameraMatrix1,  distCoeffs1,  cameraMatrix2,  distCoeffs2,
    // OutputArray R, T, E,  F  
    //rms : 重投影误差！！！！！！！
    //矫正双目！！！！！！！！！
        double rms = stereoCalibrate(objectPoints, imagePoints[0], imagePoints[1],
...
>>>>>>> 2f5341083fb654fb398aafd06fb8e622d07055c9
    ...
    // epipolar geometry constraint: m2^t*F*m1=0  对极几何极线约束！！！！！！！！！！！！！！！！！！
    ...
    //InputArray cameraMatrix1, distCoeffs1, cameraMatrix2, distCoeffs2, InputArray R, InputArray T,
...
int main(int argc, char **argv)
{
    ...
    bool ok = readStringList(imagelistfn, imagelist); //读stereo_calib.xml里输入的左右目图像list
