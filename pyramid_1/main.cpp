...
int main()
{
    ...
    namedWindow("big", WINDOW_AUTOSIZE);

    //创建轨迹条
    createTrackbar(resizeTypeName, "small", &resizeTypeValue, resizeTypeMaxValue, shrinkFun);
    shrinkFun(resizeTypeValue, 0);

    createTrackbar(resizeTypeName, "big", &resizeTypeValue, resizeTypeMaxValue, enlargeFun);
